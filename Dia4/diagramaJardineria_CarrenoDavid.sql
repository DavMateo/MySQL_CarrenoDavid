...
CREATE TABLE cliente(
    ...
    codigo_empleado_rep_ventas INT(11) UNSIGNED,
...
CREATE TABLE pedido(
	codigo_pedido INT(11) UNSIGNED NOT NULL UNIQUE,
...
CREATE TABLE detalle_pedido(
	codigo_pedido INT(11) UNSIGNED NOT NULL,
